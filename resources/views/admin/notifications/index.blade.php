...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Semua notifikasi sistem</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                <strong>User:</strong> {{ $notification->data['user'] }}
                            </p>
                            @endif
                            @if(isset($notification->data['barang']))
                            <p class="text-sm text-gray-600 mt-1">
        ...
        <div class="p-12 text-center">
            ...
            <p class="text-sm text-gray-400 mt-1">Notifikasi sistem akan muncul di sini</p>
        </div>
        @endforelse
    </div>
