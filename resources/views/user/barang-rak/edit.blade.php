                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                                ...
                                @if($assignment->stock->kategori === 'aset_sewa')
                                ...
                                @else
                                    <span class="inline-flex items-center gap-1 px-2 py-0.5 bg-orange-100 text-orange-700 text-xs font-semibold rounded-full ml-2">Material Umum</span>
                                @endif
                            </div>
                            <div>
