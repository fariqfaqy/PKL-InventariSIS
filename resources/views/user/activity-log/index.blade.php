...
@section('title', 'Activity Log Saya')
...
<div class="p-6 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Activity Log Saya</h1>
            <p class="text-gray-600 mt-1">Riwayat aktivitas Anda di sistem</p>
        </div>
    </div>

    <!-- Filter Section -->
    <div class="bg-white rounded-xl shadow-md p-6">
        <form method="GET" action="{{ route('user.activity-log.index') }}" class="space-y-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('user.activity-log.index') }}" class="flex items-center gap-2 px-6 py-2.5 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-all duration-200">
        ...
        <div class="bg-white rounded-xl shadow-md p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-600 mt-1">{{ number_format($stats['week']) }}</p>
                </div>
