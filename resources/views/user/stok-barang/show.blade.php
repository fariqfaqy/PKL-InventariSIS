...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        <div class="mb-6">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="mt-4 text-center">
                    <p class="text-xs text-gray-600 font-mono bg-gray-100 px-3 py-1 rounded inline-block">{{ $stock->kodebarang }}</p>
                </div>
            </div>
            @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="text-gray-800">{{ $stock->updated_at->format('d M Y, H:i') }} WIB</p>
            </div>
        ...
        @if($stock->kategori === 'aset_sewa' && $stock->user_id && $stock->status_kondisi === 'digunakan')
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <div class="text-center py-12">
            ...
            <p class="text-gray-500">Belum ada riwayat pemakaian untuk barang ini</p>
        </div>
        @endif
    </div>
    @endif
