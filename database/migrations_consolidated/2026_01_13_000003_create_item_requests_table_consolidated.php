...
return new class extends Migration
{
    ...
    {
        // Drop foreign key from keluar table first
        Schema::table('keluar', function (Blueprint $table) {
