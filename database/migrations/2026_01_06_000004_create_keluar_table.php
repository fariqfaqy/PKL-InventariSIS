...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('keluar', function (Blueprint $table) {
            ...
            // Relations
            $table->unsignedBigInteger('id_request')->nullable()->index()
            ...
            $table->string('kategori')->nullable()
                  ->comment('Kategori barang: aset_sewa, material_umum, aset_tetap');
            
            // Rental Duration (untuk aset_sewa)
            ...
            $table->string('tipe_request')->nullable()
                  ->comment('Tipe request: pakai_habis_pakai, pinjam_material (dari request_barang)');
